class ArrayExercicesApp {
   //Exercise 1 Creare un array contenente i primi 100 numeri naturali
   private createArrayWith100Nums = ():number[] => Helpers.arrCreate(Helpers.ONE_HUNDRED).map(i => ++i)
   //Exercise 2 Creare un array contenente i primi 50 numeri pari
   private createArrayWith50EvenNums = ():number[] => Helpers.arrCreate(Helpers.ONE_HUNDRED).filter(i => i % Helpers.TWO === Helpers.ZERO)
   //Exercise 3 Creare un array contenente i primi 50 numeri dispari
   private createArrayWith50OddNums = ():number[] => Helpers.arrCreate(Helpers.ONE_HUNDRED).filter(i => i % Helpers.TWO !== Helpers.ZERO)
   //Exercise 4 Creare un array contenente i 50 pari e i 50 dispari alternati ed invertiti di segno esempio: array1=[2, 4, 6] array2=[1,3,5] array3 = [-1,-2,-3,-4,-5,-6]
   ...
   //Exercise 5 Invertire l'ordine degli elementi dell'array dell'Esercizio 1
   private invertFirstArray = ():number[] => exercises.createArrayWith100Nums().reverse()
   //Exsercise 6 Sommare l'array dell'Esercizio 1 all'array dell'Esercizio 4
